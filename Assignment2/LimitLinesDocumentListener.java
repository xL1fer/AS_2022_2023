...
/*
 * https://github.com/kentcdodds/Java-Helper/blob/main/src/com/kentcdodds/javahelper/extras/LimitLinesDocumentListener.java
 *
...
public class LimitLinesDocumentListener implements DocumentListener {
  /*
   * Maximum number of lines to be stored in the Document.
   */
  private int maximumLines;
  /*
   * Specify if text is to be removed from the start or the end of the Document.
   */
