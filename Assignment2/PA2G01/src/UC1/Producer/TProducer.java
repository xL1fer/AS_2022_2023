...
import UC1.Producer.Sensor.ISensor_Producer;
import UC1.Producer.Sensor.SensorData;
...
public class TProducer implements Runnable {
    ...
    public void run() {
        ...
        /*
        *  configs[0] -> sendingMode
        *  configs[1] -> requestTimeout
        *  configs[2] -> maxBlock
        *  configs[3] -> linger
        */
        int[] configs = this.mSensor.waitStart();
        
        this.properties.put("request.timeout.ms", configs[1]);
        this.properties.put("max.block.ms", configs[2]);
        this.properties.put("linger.ms", configs[3]);
        ...
        if (mSensor.waitFinish() == 0) {
            long elapsedTime = System.currentTimeMillis() - startTime;
            PProducer.elapsedTimeLabel.setText("Elapsed Time: " + elapsedTime / 1000 + " (s)");
