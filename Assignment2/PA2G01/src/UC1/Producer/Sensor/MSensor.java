...
public class MSensor implements ISensor {
    ...
    @Override
    public void signalStart(int sendingMode, int producersNumber, int requestTimeout, int maxBlock, int linger) {
        try {
            this.rl.lock();
    ...
    public int[] waitStart() {
        ...
        int[] configs = { this.sendingMode, this.requestTimeout, this.maxBlock, this.linger };
        return configs;
    }
