        ...
        try {
            while (true) {
                ...
                records.forEach(record -> {
                    ...
                    this.totalRecords++;
                    totalRecordsLabel.setText("Total Records: " + this.totalRecords);
                });
            }
